...
DELETE_SQL = ""
LIMIT = -1
INPUT_FILE = 'https://data.louisvilleky.gov/sites/default/files/Crime_Data_2017_1.csv'
...
def lambda_handler(event, context):
	...
	if 'AWS_REGION' not in os.environ:
		...
		parse_csv('rw', 'civicdataalliance', 'civicdata.crogewynsqom.us-east-1.rds.amazonaws.com', 'crimeDataQA', 'louisvilleky', max_inserts=10)
